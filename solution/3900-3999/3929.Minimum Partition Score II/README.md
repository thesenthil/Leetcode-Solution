...
<ul>
	...
	<li>The first subarray has <code>sum = 5</code> and <code>value = 5 * 6 / 2 = 15</code>.</li>
	<li>The second subarray has <code>sum = 1 + 2 + 1 = 4</code> and <code>value = 4 * 5 / 2 = 10</code>.</li>
...
<ul>
	...
	<li>This subarray has <code>sum = 1 + 2 + 3 + 4 = 10</code> and <code>value = 10 * 11 / 2 = 55</code>.​​​​​​​</li>
...
<ul>
	...
	<li>Each subarray has <code>sum = 1</code> and <code>value = 1 * 2 / 2 = 1</code>.</li>
