...
<div class="example-block">
<p><strong>Input:</strong> <span class="example-io">nums = [6,7,8], k = 2</span></p>

<p><strong>Output:</strong> <span class="example-io">0</span></p>

<p><strong>Explanation:</strong></p>

<p>The array already satisfies the condition with <code>x = 0</code> and <code>y = 1</code>. Thus, no operations are required.</p>
</div>
